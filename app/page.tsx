...
import { Book, FileText, Wallet, Code, Network, Shield, ArrowRight, ExternalLink, MessageCircle, HelpCircle, Search, Zap, Globe } from 'lucide-react'
  ...
  return (
    <Box className="min-h-screen flex flex-col">
      ...
      <Box tag="header" className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <Box className="container flex h-16 items-center justify-between px-4 md:px-6 mx-auto max-w-6xl">
          <Link href="/" style={css('flex items-center gap-2')}>
            <Logo size={28} />
            <Box tag="span" className="font-semibold text-lg">Help Center</Box>
          </Link>
      ...
      <Box tag="main" className="flex-1">
        {/* Hero */}
        <Box tag="section" className="py-16 md:py-24 px-4 md:px-6">
          <Box className="container mx-auto max-w-4xl text-center">
            <Box className="inline-flex items-center justify-center p-3 bg-primary/5 rounded-full mb-6">
              <HelpCircle style={css('h-8 w-8 text-primary')} />
            </Box>
            ...
            <Box className="max-w-xl mx-auto">
              <Box className="relative">
                <Search style={css('absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground')} />
                <Box tag="input"
                  type="text"
              ...
              <Box tag="p" className="text-xs text-muted-foreground mt-2">
        ...
        {/* Categories */}
        <Box tag="section" className="py-12 px-4 md:px-6 bg-muted/30">
        ...
        <Box tag="section" className="py-16 px-4 md:px-6">
          <Box className="container mx-auto max-w-4xl">
            <Box tag="h2" className="text-2xl font-bold mb-8 text-center">Quick Links</Box>
              ...
              {quickLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Box tag="span" className="font-medium">{link.title}</Box>
                    <ExternalLink style={css('h-4 w-4 ml-auto text-muted-foreground')} />
                  </Box>
                );
              })}
            </Box>
        ...
        <Box tag="section" className="py-16 px-4 md:px-6 bg-muted/30 border-t border-border/50">
          <Box className="container mx-auto max-w-4xl text-center">
            <Zap style={css('h-10 w-10 mx-auto mb-4 text-primary')} />
            <Box tag="h2" className="text-2xl font-bold mb-4">Can&apos;t find what you&apos;re looking for?</Box>
            ...
            <Box className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <MessageCircle style={css('h-4 w-4')} />
                Join Discussion
              </Box>
              <Box tag="a"
                href="https://github.com/luxfi"
